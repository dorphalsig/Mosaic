...
public class AutoComplete {
	...
	private boolean DISPLAY_OPTIONS = false; 			// Display options based on the type of the input.
	private boolean COLON_ADD_PATH = false; 			// We might have a :: where there is a path to the left ...
	...
	private boolean COMPLETE_PARENTHESIS = false;		// Insert the corresponding parenthesis...
	...
	public boolean isApostropheAddQuotes() { 		return MAIN_SWITCH && COMPLETE_QUOTES; 	}
