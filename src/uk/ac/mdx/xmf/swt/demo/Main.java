...
public class Main {
    ...
    private void createshell() {
        ...
        shell.setSize(new org.eclipse.swt.graphics.Point(screenWidth, screenHeight));
        ...
        tabFolderDiagram = new CTabFolder(sectionTopMiddle, SWT.BORDER | SWT.H_SCROLL);
        ...
        consoleView = new ConsoleView(tabFolderConsole, SWT.BORDER, tabItemConsole);
        ...
        Thread tmodelBrowserClient = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    xos.newMessageClient("com.ceteva.modelBrowser", modelBrowserClient);
                } catch (Throwable t) {
                    System.out.println(t);
                    t.printStackTrace();
                }
     ...
     *            the diagram
     */
    public void startNewDiagram(String identity, final uk.ac.mdx.xmf.swt.model.Diagram diagram) {
        CTabItem tabItem = new CTabItem(tabFolderDiagram, SWT.BORDER);
        tabItem.setText(diagram.getName());

        SashForm sashFormDiagram;
        sashFormDiagram = new SashForm(tabFolderDiagram, SWT.BORDER | SWT.H_SCROLL);
        sashFormDiagram.setBounds(0, 0, tabFolderDiagram.getBounds().width, tabFolderDiagram.getBounds().height);
        ...
        DiagramView view = new DiagramView(sashFormDiagram, SWT.NONE, palette, display, diagramClient, diagram, tabItem);
        views.add(view);
