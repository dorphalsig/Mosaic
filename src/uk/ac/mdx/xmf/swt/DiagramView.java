...
public class DiagramView extends View {
     ...
     */
    public DiagramView(Composite parent, int style, Palette palette, Display display, DiagramClient diagramClient, AbstractDiagram diagram,
            CTabItem tabItem) {
        super(parent, style);
        this.parent = parent;
        ...
        canvas.setBounds(0, 0, (int) (parent.getBounds().width * 0.8), parent.getBounds().height);
    ...
    public void registerListener() {
        ...
        canvas.addListener(SWT.MouseDown, new Listener() {
            public void handleEvent(Event e) {
                ...
                Iterator<String> keySetIterator = nodeModels.keySet().iterator();
                ...
                while (keySetIterator.hasNext()) {
                    ...
                    if (figureNodes.get(key).containsPoint(location2)) {
                        ...
                        org.eclipse.draw2d.geometry.Point p = new org.eclipse.draw2d.geometry.Point(0, 0);
                        ...
                        org.eclipse.draw2d.geometry.Point l = figureNodes.get(key).getLocation();
                        ...
                        MenuBuilder.calculateMenu(identitiesNode, managerNode, null);
                ...
                while (nodeShapeItr.hasNext()) {
                    ...
                    NodeShapeFigure shape = (NodeShapeFigure) nodeShapes.get(key);
                ...
                Iterator<String> edgeDragIterator = edgeModels.keySet().iterator();
                ...
                while (edgeTextItr.hasNext()) {
                    ...
                    if (label.containsPoint(location2)) {
                        ...
                        MenuBuilder.calculateMenu(identitiesEdge, managerEdge, null);
                ...
                while (edgeIterator.hasNext()) {
                    ...
                    org.eclipse.draw2d.geometry.Point topRef = edgeFigure.getSourceAnchor().getReferencePoint();
                    org.eclipse.draw2d.geometry.Point bottomRef = edgeFigure.getTargetAnchor().getReferencePoint();
                ...
                if (isConnection) // connection
                {
                    if (ports.size() > 1) {
                        ...
                        connectionCommand.setSource(String.valueOf(Integer.valueOf(source) + 1));
                        connectionCommand.setTarget(String.valueOf(Integer.valueOf(target) + 1));
                    ...
                    createNodeCommand = new CreateNodeCommand(nodeEditPart, toolIdentity, location2);
        ...
        canvas.addListener(SWT.MouseMove, new Listener() {
            ...
            public void handleEvent(Event arg0) {
                ...
                String getTool = Main.getInstance().getPalette().getSelectImage();
                ArrayList connections = new ArrayList<>();
                connections = Main.getInstance().getPalette().getConnections();
                ...
                if (isConnection) {
                    {
                        Iterator<String> keySetIterator = nodeShapes.keySet().iterator();
                ...
                if (!mouseDown) {
                    ...
                    while (keySetIterator.hasNext()) {
                        ...
                        if (shape.isVisible()) {
                            if (getPoint.equalsIgnoreCase(VisualElementEvents.topMiddlePoint))

                            {
                                canvas.setCursor(Display.getCurrent().getSystemCursor(SWT.CURSOR_SIZEN));
                            } else if (getPoint.equalsIgnoreCase(VisualElementEvents.rightMiddlePoint))

                            {
                                canvas.setCursor(Display.getCurrent().getSystemCursor(SWT.CURSOR_SIZEE));
                            } else if (getPoint.equalsIgnoreCase(VisualElementEvents.bottomMiddlePoint))

                            {
                                canvas.setCursor(Display.getCurrent().getSystemCursor(SWT.CURSOR_SIZEN));
                            } else if (getPoint.equalsIgnoreCase(VisualElementEvents.leftMiddlePoint))

                            {
                                canvas.setCursor(Display.getCurrent().getSystemCursor(SWT.CURSOR_SIZEE));
                            } else if (getPoint.equalsIgnoreCase(VisualElementEvents.leftTopCornerPoint)) {
                                canvas.setCursor(Display.getCurrent().getSystemCursor(SWT.CURSOR_SIZESE));
                            } else if (getPoint.equalsIgnoreCase(VisualElementEvents.rightTopCornerPoint)) {
                                canvas.setCursor(Display.getCurrent().getSystemCursor(SWT.CURSOR_SIZENE));
                            } else if (getPoint.equalsIgnoreCase(VisualElementEvents.rightBottomCornerPoint)) {
                                canvas.setCursor(Display.getCurrent().getSystemCursor(SWT.CURSOR_SIZESE));
                            } else if (getPoint.equalsIgnoreCase(VisualElementEvents.leftBottomCornerPoint)) {
                                canvas.setCursor(Display.getCurrent().getSystemCursor(SWT.CURSOR_SIZENE));
                            } else {
                                canvas.setCursor(Display.getCurrent().getSystemCursor(SWT.CURSOR_ARROW));
                            }
                    ...
                    while (edgeTextItr.hasNext()) {
                        ...
                        if (label.containsPoint(location2)) {
                            canvas.setCursor(Display.getCurrent().getSystemCursor(SWT.CURSOR_SIZEALL));
                            // getPoint = VisualElementEvents.edgeLabelPoint;
                            // edgeTextId=key;
                        }
                    }
                ...
                if (!mouseDown) {
                    ...
                    while (edgeIterator.hasNext()) {
                        ...
                        if (edgeShapes.get(edgeSelect) != null && edgeShapes.get(edgeSelect).isVisible()) {
                            if (getEdgePoint.equalsIgnoreCase(VisualElementEvents.wayPointEdgePoint))

                            {
                                canvas.setCursor(Display.getCurrent().getSystemCursor(SWT.CURSOR_SIZEALL));

                            } else if (getEdgePoint.equalsIgnoreCase(VisualElementEvents.moveEdgePoint))
                ...
                if (mouseDown) {
                    ...
                    if (shape != null && (getPoint.equalsIgnoreCase(VisualElementEvents.rightMiddlePoint))) {
                    ...
                    } else if (shape != null && (getPoint.equalsIgnoreCase(VisualElementEvents.leftMiddlePoint))) {
                        Node node = nodeModels.get(nodeSelect);
                        Dimension size = new Dimension();
                        size.width = Math.abs(location2.x - node.getLocation().x);
                        size.height = nodeShapes.get(nodeSelect).getSize().height - 4;

                        org.eclipse.draw2d.geometry.Point p = new org.eclipse.draw2d.geometry.Point(location2.x, node.getLocation().y);
                        ...
                        resizeShape = true;
                        rectShape.setVisible(true);
                    } else if (shape != null && (getPoint.equalsIgnoreCase(VisualElementEvents.topMiddlePoint))) {
                        Node node = nodeModels.get(nodeSelect);
                        Dimension size = new Dimension();
                        size.width = node.getSize().width;
                        size.height = Math.abs(node.getLocation().y - location2.y);
                        org.eclipse.draw2d.geometry.Point p = new org.eclipse.draw2d.geometry.Point(node.getLocation().x, location2.y);
                        rectShape.setLocation(p);
                        rectShape.setSize(size);
                        rectShape.setBackgroundColor(ColorConstants.lightGray);
                        rectShape.setVisible(true);
                        resizeShape = true;
                    } else if (shape != null && (getPoint.equalsIgnoreCase(VisualElementEvents.bottomMiddlePoint))) {

                        Node node = nodeModels.get(nodeSelect);
                        Dimension size = new Dimension();
                        size.width = node.getSize().width;
                        size.height = Math.abs(node.getLocation().y - location2.y);
                        org.eclipse.draw2d.geometry.Point p = new org.eclipse.draw2d.geometry.Point(node.getLocation().x, node
                                .getLocation().y);
                        rectShape.setLocation(p);
                        ...
                        rectShape.setVisible(true);
                        resizeShape = true;
                    } else if (shape != null && (getPoint.equalsIgnoreCase(VisualElementEvents.leftTopCornerPoint))) {
                        Node node = nodeModels.get(nodeSelect);
                        Dimension size = new Dimension();
                        size.width = node.getSize().width - location2.x + node.getLocation().x;
                        size.height = Math.abs(node.getLocation().y - location2.y) + node.getSize().height;
                        org.eclipse.draw2d.geometry.Point p = new org.eclipse.draw2d.geometry.Point(node.getLocation().x, location2.y);
                        ...
                        rectShape.setVisible(true);
                        resizeShape = true;
                    } else if (shape != null && (getPoint.equalsIgnoreCase(VisualElementEvents.rightTopCornerPoint))) {
                        Node node = nodeModels.get(nodeSelect);
                        Dimension size = new Dimension();
                        size.width = Math.abs(location2.x - node.getLocation().x);
                        size.height = Math.abs(node.getLocation().y - location2.y) + node.getSize().height;
                        ...
                        rectShape.setVisible(true);
                        resizeShape = true;
                    } else if (shape != null && (getPoint.equalsIgnoreCase(VisualElementEvents.rightBottomCornerPoint))) {
                        Node node = nodeModels.get(nodeSelect);
                        Dimension size = new Dimension();
                        size.width = Math.abs(location2.x - node.getLocation().x);
                        size.height = Math.abs(node.getLocation().y - location2.y);
                        ...
                        rectShape.setVisible(true);
                        resizeShape = true;
                    } else if (shape != null && (getPoint.equalsIgnoreCase(VisualElementEvents.leftBottomCornerPoint))) {
                        Node node = nodeModels.get(nodeSelect);
                        Dimension size = new Dimension();
                        size.width = Math.abs(location2.x - node.getLocation().x) + node.getSize().width;
                        size.height = Math.abs(node.getLocation().y - location2.y);
                        org.eclipse.draw2d.geometry.Point p = new org.eclipse.draw2d.geometry.Point(location2.x, node.getLocation().y);
                        rectShape.setLocation(p);
                        rectShape.setSize(size);
                        ...
                        if (nodeIsSelected //&& canvas.getCursor().hashCode() == 65539
                                && !getPoint.equalsIgnoreCase(VisualElementEvents.edgeLabelPoint)) {
                            Node node = nodeModels.get(nodeSelect);
                            Dimension size = new Dimension();
                            size = node.getSize();
                    ...
                    if (label != null && getPoint.equalsIgnoreCase(VisualElementEvents.edgeLabelPoint)) {
        ...
        canvas.addListener(SWT.MouseDoubleClick, new Listener() {
            ...
            public void handleEvent(Event arg0) {
                ...
                while (itrLabel.hasNext()) {
                    ...
                    select = model.getParent().getParent().getParent().getIdentity();

                    Node node = nodeModels.get(select);
                    if (node != null)
                        p = new Point(node.getLocation().x + model.getLocation().x, node.getLocation().y + model.getLocation().y);
                    else
                        p = new Point(0, 0);
                    if (checkRectangleBoundary(location2.x, location2.y, p.x, p.y, width, height)) {
                        textEdits.get(key).performDirectEdit(model, p, d);
                    }
                }
                // edit multiline label, for example, not
                Iterator<String> itrMultiline = figureMulitLineTextLabels.keySet().iterator();
                ...
                while (itrMultiline.hasNext()) {
                    ...
                    if (checkRectangleBoundary(location2.x, location2.y, p.x, p.y, width, height)) {
                        multilineTextEdits.get(key).performDirectEdit(model, p, d);
                    }
                }

                // edit edge label text

                Iterator<String> itrEdgeLabel = edgeLabelFigures.keySet().iterator();
                ...
                while (itrEdgeLabel.hasNext()) {
                    ...
                    EdgeTextEditPart edgeTextEditPart = edgeTextEditParts.get(model.getIdentity());
                    ...
                    if (width != 0) {
                        if (checkRectangleBoundary(location2.x, location2.y, l.getLocation().x, l.getLocation().y, width, height)) {
        ...
        canvas.addListener(SWT.MouseUp, new Listener() {
            ...
            public void handleEvent(Event arg0) {
                ...
                if (resizeShape && (getPoint.equalsIgnoreCase(VisualElementEvents.rightMiddlePoint))) {
                    Node node = nodeModels.get(nodeSelect);
                    Dimension size = new Dimension();
                    size.width = Math.abs(location2.x - node.getLocation().x);
                    size.height = node.getSize().height;
                    node.moveResize(size);
                } else if (resizeShape && (getPoint.equalsIgnoreCase(VisualElementEvents.leftMiddlePoint))) {
                    Node node = nodeModels.get(nodeSelect);
                    Dimension size = new Dimension();
                    size.width = Math.abs(location2.x - node.getLocation().x) + node.getSize().width;
                    size.height = node.getSize().height;
                    ...
                    org.eclipse.draw2d.geometry.Point p = new org.eclipse.draw2d.geometry.Point(location2.x, node.getLocation().y);
                    node.moveResize(p);
                } else if (resizeShape && (getPoint.equalsIgnoreCase(VisualElementEvents.topMiddlePoint))) {
                    Node node = nodeModels.get(nodeSelect);
                    Dimension size = new Dimension();
                    size.width = node.getSize().width;
                    size.height = Math.abs(node.getLocation().y - location2.y) + node.getSize().height;
                    ...
                    org.eclipse.draw2d.geometry.Point p = new org.eclipse.draw2d.geometry.Point(node.getLocation().x, location2.y);
                    node.moveResize(p);
                } else if (resizeShape && (getPoint.equalsIgnoreCase(VisualElementEvents.bottomMiddlePoint))) {
                    Node node = nodeModels.get(nodeSelect);
                    Dimension size = new Dimension();
                    size.width = node.getSize().width;
                    size.height = Math.abs(node.getLocation().y - location2.y);
                    node.moveResize(size);
                } else if (resizeShape && getPoint.equalsIgnoreCase(VisualElementEvents.leftTopCornerPoint)
                        || getPoint.equalsIgnoreCase(VisualElementEvents.rightTopCornerPoint)
                        || getPoint.equalsIgnoreCase(VisualElementEvents.leftBottomCornerPoint)
                        || getPoint.equalsIgnoreCase(VisualElementEvents.rightBottomCornerPoint)) {
                    Node node = nodeModels.get(nodeSelect);
                    node.moveResize(rectShape.getLocation());
                    node.moveResize(rectShape.getSize());
                } else if (resizeShape && (getPoint.equalsIgnoreCase(VisualElementEvents.edgeLabelPoint))) {
                    EdgeText text = edgeTexts.get(edgeTextId);
                    org.eclipse.draw2d.geometry.Point p1 = edgeLabelFigures.get(edgeTextId).getLocation();
                    org.eclipse.draw2d.geometry.Point p = new org.eclipse.draw2d.geometry.Point(location2.x - p1.x, location2.y - p1.y);
                ...
                if (resizeEdgeShape) {
                    ...
                    CreateWaypointCommand createWaypointCommand = new CreateWaypointCommand(edge, 0, location2);
    ...
    public org.eclipse.draw2d.geometry.Point translateToRelativeLocation(Point location) {
        Point point = null;
        point = Main.display.map(null, canvas, location);
        org.eclipse.draw2d.geometry.Point point2 = new org.eclipse.draw2d.geometry.Point(0, 0);
        point2.x = point.x;
        point2.y = point.y;
     ...
     */
    private boolean checkRectangleBoundary(float pointX, float pointY, float rectangleX, float rectangleY, float width, float height) {
        boolean isInside = ((pointX > rectangleX) && (pointX < rectangleX + width) && (pointY > rectangleY) && (pointY < rectangleY
                + height));
        return isInside;
    }
    ...
    public void refresh(Vector displays) {
        ...
        for (int i = 0; i < contents.size(); i++) {
            ...
            if (iModel instanceof Node) {
                ...
                Rectangle rect = new Rectangle(((Node) iModel).getLocation(), ((Node) iModel).getSize());
                ...
                MultilineTextFigure label = (MultilineTextFigure) multilineTextEditPart.createFigure();
                ...
                EdgeFigure edgeFigure = (EdgeFigure) edgeEditPart.createFigure();
                if (sourceAnchor != null && targetAnchor != null) {
                    ...
                    org.eclipse.draw2d.geometry.Point location1 = sourceAnchor.getReferencePoint();
                    org.eclipse.draw2d.geometry.Point location2 = targetAnchor.getReferencePoint();
                    ...
                    edgeEditPartFigures.put(((Edge) iModel).getIdentity(), edgeEditPart);
                ...
                EdgeLabelFigure label = (EdgeLabelFigure) edgeEdgeTextEdit.createFigure();
                ...
                edgeTexts.put(((EdgeText) iModel).getIdentity(), (EdgeText) iModel);
                edgeTextEditParts.put(((EdgeText) iModel).getIdentity(), edgeEdgeTextEdit);
                ...
                ImageFigure imageFigure = (ImageFigure) imageEditPart.createFigure();
                if (imageFigure != null) {
    ...
    public void delTool(String parent, String label, String identity, boolean connection, String icon) {
