...
public interface ZoomableEditPart {
	...
	/**
	 * zoomTo This method allows implementators to zoom to a certain level
	 * centered around a given point.
	 * 
	 * @param zoom
	 *            double value where 1.0 represents 100%.
	 * @param center
	...
	/**
	 * zoomTo This method allows implementors to zoom into or out to a
	 * rectangular area.
	 * 
	 * @param rect
	 *            Rectangle that the edit part will zoom into our out to in
