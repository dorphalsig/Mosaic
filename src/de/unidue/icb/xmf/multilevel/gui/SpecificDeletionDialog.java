...
//		display = Display.getDefault();
		display = new Display();
		Shell shlIntrinsicDeletion = new Shell();
		...
		coM3.setBackground(display.getSystemColor(SWT.COLOR_WIDGET_BACKGROUND));
		
		coM2 = new Composite(composite_1, SWT.NONE);
		coM2.setBackground(display.getSystemColor(SWT.COLOR_WIDGET_BACKGROUND));
		
		coM1 = new Composite(composite_1, SWT.NONE);
		coM1.setBackground(display.getSystemColor(SWT.COLOR_WIDGET_BACKGROUND));
		
		Composite composite_2 = new Composite(composite, SWT.NONE);
		composite_2.setLayout(new FillLayout(SWT.VERTICAL));
		composite_2.setLayoutData(new RowData(35, 113));
		
		Font font = new Font(Display.getCurrent(), new FontData("Segoe UI", 14, SWT.NORMAL));
		...
		scLevel.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				if(scLevel.getSelection() == 2){
					coM4.setBackground(display.getSystemColor(SWT.COLOR_RED));
					coM3.setBackground(display.getSystemColor(SWT.COLOR_RED));
					coM2.setBackground(display.getSystemColor(SWT.COLOR_RED));
		...
		btnDeleteSlot.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				...
				if(SpecificDeletionDialog.btnDeleteSlot.getSelection()){
					coM1.setBackground(display.getSystemColor(SWT.COLOR_RED));
