...
public class IconManager {
	...
	// private static Image getImageFromFileRelative(Plugin plugin,String
	// filename) {
	...
	// }
	//
	// public static ImageDescriptor getImageDescriptor(Plugin plugin,String
	// filename) {
	//
	// // test to see whether the name is absolute or relative
	//
	...
	// public static ImageDescriptor getImageDescriptorRelative(Plugin
